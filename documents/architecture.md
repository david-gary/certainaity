# Certainaity — System Architecture

## Overview

Certainaity is a forensic image manipulation detection system designed for use in legal, investigative, and journalistic contexts. The system accepts an image as input and produces a structured forensic report identifying manipulated regions, the type of manipulation, confidence scores, and supporting evidence.
...
**CLI Tool**
- Single binary (`certainaity analyze <image_path> [--output json|pdf|both]`)
...
**A. JSON report** — see `certainaity_plan.md` for full schema.
...
- Footer: "Generated by Certainaity vX.Y — for investigative use only"
