"""ForenScope command-line tool for local forensic image analysis."""
...
def _cmd_analyze(args: argparse.Namespace) -> int:
    ...
    from forenscope.report import generate_report, save_json_report, save_pdf_report
...
def _build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(
        prog="forenscope",
        description="ForenScope forensic image manipulation detector",
    )
